...
@implementation VehicleLibraryTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
        [[NSBundle mainBundle] loadNibNamed:@"VehicleLibraryTableViewCell" owner:self options:nil];

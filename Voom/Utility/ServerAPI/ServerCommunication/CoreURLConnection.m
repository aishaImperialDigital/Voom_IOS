...
- (void)handleCachedData:(NSData *)cachedData{
    //if (responseBuffered) {
        ...
        [self logCachedResponse:cachedData];
...
//            [self.delegate connection:self hasDownloaded:(NSInteger)[self.file offsetInFile]];
//        }
//    }
...
- (void)logCachedResponse:(NSData*)cachedData {
 //   nsLog(@"Connection returned data: %@", [[NSString alloc] initWithData:cachedData encoding:NSASCIIStringEncoding]);
}

...
- (void)service:(CoreWebService *)service hasDownloaded:(NSInteger)downloadedBytes;
- (void)service:(CoreWebService *)service didFinishStreaming:(NSString *)filePath;
- (BOOL)service:(CoreWebService *)service didReceiveError:(EVEError *)error;
- (void)service:(CoreWebService *)service didGet:(id)object;
- (void)service:(CoreWebService *)service didReceiveResponseHeader:(NSDictionary *)responseHeader;
- (void)service:(CoreWebService *)service didDidReceiveCached:(id)xmlObject;
- (void)service:(CoreWebService *)service didFinishCachedStreaming:(NSString *)filePath;
- (void)service:(CoreWebService *)service didUpdateDownloadProgress:(EVEDataDownloadProgress*)progress;

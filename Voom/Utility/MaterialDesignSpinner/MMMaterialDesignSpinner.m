...
-(instancetype)initWithFrame:(CGRect)frame WithColor:(UIColor *)clr{
    self.colr = clr;
    if (self = [super initWithFrame:frame]) {
        [self initialize];
    }
...
- (void)tintColorDidChange {
    ...
    self.progressLayer.strokeColor = kAppSecondaryColor.CGColor;
    if (self.colr) {
        self.progressLayer.strokeColor = self.colr.CGColor;
    }
}
...
- (CAShapeLayer *)progressLayer {
    if (!_progressLayer) {
        _progressLayer = [CAShapeLayer layer];
         _progressLayer.strokeColor =  kAppSecondaryColor.CGColor;
        if (self.colr) {
             _progressLayer.strokeColor =  self.colr.CGColor;
        }
       //[UIColor colorWithRed:122.0/255.0 green:194.0/255.0 blue:198.0/255.0 alpha:1.0].CGColor;// self.tintColor.CGColor;
        _progressLayer.fillColor = nil;
        _progressLayer.lineWidth = 3.6f;
    }
